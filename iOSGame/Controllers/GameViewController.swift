...
class GameViewController: UIViewController {
        ...
        if myMove == .idle && otherMove == .idle {
            ...
            if let mMove = myMove, let oMove = otherMove {
                ...
                if mMove > oMove {
                    ...
                    animatinFinalMoves(animatingImageView: myHandImage, space: -space, game: game)
                } else  if oMove > mMove {
                    animatinFinalMoves(animatingImageView: opponentHandImage, space: space, game: game)
                } else {
                    //draw
                }
            }
    ...
    private func animatinFinalMoves(animatingImageView: UIImageView, space: CGFloat, game: Game) {
